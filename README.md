...
This is an app for using Rails as a backend to be supported with [React](https://github.com/Daniel-Kigozi/hello-react-front-end) 
as a front end service

-[React-front-end link](https://github.com/Daniel-Kigozi/hello-react-front-end)
...
```sh
  cd my-folder
  git clone https://github.com/Daniel-Kigozi/hello-rails-back-end.git
```
